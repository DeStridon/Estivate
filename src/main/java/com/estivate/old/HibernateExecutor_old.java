...
//
//@Slf4j
//public class HibernateExecutor_old {
//	
//	private final Session session;
//	
//	public HibernateExecutor_old(Session session) {
//		this.session = session;
//	}
//	
//	public List<EstivateResult_old> list(EstivateQuery joinQuery){
//
//		try {
//
//			NativeQuery<Tuple> query = session.createNativeQuery(joinQuery.compile(), Tuple.class);
//			List<Tuple> tuples = query.getResultList();
//			List<EstivateResult_old> results = tuples.stream().map(tuple -> new EstivateResult_old(joinQuery, tuple)).collect(Collectors.toList());
//				
//			return results;
//			
...
//			List<Tuple> tuples = query.getResultList();
//			
//			List<U> results = tuples.stream().map(tuple -> new EstivateResult_old(joinQuery, tuple).mapAs(clazz)).collect(Collectors.toList());
//			return results;
//			
//		} catch (HibernateException e) {
//			log.error("DB Error", e, joinQuery.compile());
...
//	
//	//@AllArgsConstructor
//	public static class EstivateResult_old{
//		
//		EstivateQuery query;
//		Tuple tuple;
//		
//		public EstivateResult_old(EstivateQuery query, Tuple tuple) {
//			this.query = query;
//			this.tuple = tuple;
//		}
//		
