...
public class Result {
	...
	public <U> U mapTo(Entity<U> clazz) throws SecurityException, IllegalArgumentException {
		...
		String key = Query.nameMapper.mapEntityClass(clazz);
		
		U u = (U) cache.get(key);
		
		if(u == null) {
			Mapper<U> mapper = new Mapper<>(clazz.entity);
	...
	public String 	mapToString	(Class c, String attribute) 	{ return getAsString(Query.nameMapper.mapEntity(c, attribute)); }
	public String 	mapToString	(Entity e, String attribute)	{ return getAsString(Query.nameMapper.mapEntity(e, attribute)); }
	public Short 	mapToShort	(Class c, String attribute) 	{ return getAsShort(Query.nameMapper.mapEntity(c, attribute)); }
	public Short 	mapToShort	(Entity e, String attribute)	{ return getAsShort(Query.nameMapper.mapEntity(e, attribute)); }
	public Integer 	mapToInteger(Class c, String attribute) 	{ return getAsInteger(Query.nameMapper.mapEntity(c, attribute)); }
	public Integer 	mapToInteger(Entity e, String attribute)	{ return getAsInteger(Query.nameMapper.mapEntity(e, attribute)); }
	public Boolean 	mapToBoolean(Class c, String attribute) 	{ return getAsBoolean(Query.nameMapper.mapEntity(c, attribute)); }
	public Boolean 	mapToBoolean(Entity e, String attribute)	{ return getAsBoolean(Query.nameMapper.mapEntity(e, attribute)); }
	public Long 	mapToLong	(Class c, String attribute) 	{ return getAsLong(Query.nameMapper.mapEntity(c, attribute)); }
	public Long 	mapToLong	(Entity e, String attribute) 	{ return getAsLong(Query.nameMapper.mapEntity(e, attribute)); }
	public Date 	mapToDate	(Class c, String attribute)		{ return getAsDate(Query.nameMapper.mapEntity(c, attribute)); }
	public Date 	mapToDate	(Entity e, String attribute)	{ return getAsDate(Query.nameMapper.mapEntity(e, attribute)); }
