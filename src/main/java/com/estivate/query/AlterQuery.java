...
public class AlterQuery<E> {
    ...
    public static class AddColumn implements Operation {
        ...
        private final EntityColumn projectedColumn;
    }
    ...
    public AlterQuery<E> addColumn(EntityColumn projectedColumn) { return addOperation(new AddColumn(projectedColumn.getName(), projectedColumn)); }
    public AlterQuery<E> dropColumn(String columnName) { return addOperation(new DropColumn(columnName)); }
    public AlterQuery<E> modifyColumn(String columnName, EntityColumn projectedColumn) { return addOperation(new ModifyColumn(columnName, projectedColumn)); }
