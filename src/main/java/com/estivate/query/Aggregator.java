...
public class Aggregator implements EstivateNode {
	...
	public Aggregator inIfNotNull   	(Entity entity, String attribute, List<Object> values) { if(values != null) {return in(entity, attribute, values);} return this; }
	public Aggregator notInIfNotNull   	(Entity entity, String attribute, List<Object> values) { if(values != null) {return notIn(entity, attribute, values);} return this; }
	...
	public Aggregator ltOrNull(Entity entity, String attribute, Object value) {
		criterions.add(new Aggregator(GroupType.OR)
				.lt(entity, attribute, value)
				.isNull(entity, attribute));
		return this;
	}

	public Aggregator gtOrNull(Entity entity, String attribute, Object value) {
		criterions.add(new Aggregator(GroupType.OR)
				.gt(entity, attribute, value)
				.isNull(entity, attribute));
		return this;
	}
	...
	public Aggregator gteOrNull(Entity entity, String attribute, Object value) {
		criterions.add(new Aggregator(GroupType.OR)
				.gte(entity, attribute, value)
				.isNull(entity, attribute));
		return this;
	}
