...
public class QueryTest {
	...
	void orderLimitTest(){
		...
		Query<ParentEntity> projectIdAscOrderedTaskQuery = Estivate.query(ParentEntity.class).orderAsc(ParentEntity.class, ParentEntity.Fields.homeId).limit(2);
		...
		Query<ParentEntity> idDescOrderedTaskQuery = Estivate.query(ParentEntity.class).orderDesc(ParentEntity.class, AbstractEntity.Fields.id);
